...
class backup_assignment_uploadpdf_subplugin extends backup_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $comment = new backup_nested_element('assignment_uploadpdf_comment', null, array('posx', 'posy', 'width', 'rawtext', 'pageno', 'colour'));
        $annotations = new backup_nested_element('annotations');
        $annotation = new backup_nested_element('assignment_uploadpdf_annot', null, array('startx', 'starty', 'endx', 'endy', 'pageno', 'colour', 'type'));
