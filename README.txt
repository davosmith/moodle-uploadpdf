...
* The language file (assignment.php) should go in the folder
<siteroot>/mod/assignment/lang/en_utf8 UNLESS THERE IS ALREADY A FILE
THERE.
IF THERE IS ALREADY A LANGUAGE FILE IN THAT FOLDER (from a different
plugin you have installed - it is not there by default), you will need
to manually combine the two files - copy and paste the contents of the
uploadpdf version of 'assignment.php' onto the end of the original
'assignment.php'.  (I recommend making a backup copy of any original
'assignment.php', just in case). 
...
* Delete the file <siteroot>/mod/assignment/lang/en_utf8 OR remove the
  entries you added to it manually during the installation phase.
