...
$url = new moodle_url('/mod/assignment/type/uploadpdf/upload.php', array('contextid'=>$contextid,
                            'offset'=>$formdata->offset,'forcerefresh'=>$formdata->forcerefresh,'userid'=>$formdata->userid,'mode'=>$formdata->mode));
